            ...
            <li class="navbar-item dropdown header-admin">
                <a class="navbar-nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                    ...
                    <div class="admin-title">
                        <h5 class="item-title"><?php echo $first_name; ?></h5>
                        <span>Admin</span>
                    </div>
                    <div class="admin-img">
                        <img src="assets/img/profile/<?php echo $identitiyof."/".$profilepic;?>" width="40px" height="40px" alt="Admin">
                        <!-- <img src="assets/img/figure/admin.jpg" alt="Admin"> -->
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="item-header">
                        <h6 class="item-title"># <?php echo $user_id;?></h6>
                    </div>
                    <div class="item-content">
                        <ul class="settings-list">
                            ...
                            <li><a href="./config/ses_end.php"><i class="flaticon-turn-off"></i>Log Out</a></li>
                        </ul>
                    </div>
                </div>
            </li>
